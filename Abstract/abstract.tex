...
We show that every metric within the class is a Kaluza--Klein reduction of an Einstein metric on an $\R^*$ bundle over $M$. We also show that the structures are para--$c$--projectively compact in the sense of \v Cap--Gover, and interpret the compactification in terms of the tractor bundle of the projective structure.
