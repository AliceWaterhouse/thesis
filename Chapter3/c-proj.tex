...
\mynote{Remaining notes:}
\begin{itemize}
\item Need to define Levi form and degeneracy of an almost (para--)CR structure.
...
\item On the last section about the model - I think maybe some of it needs to go in the introduction, and maybe some of it chucked depending on the outcome of the item above. \end{itemize}
...
\mynote{define Levi form and degeneracy of a CR structure}
...
\mynote{I think non--degeneracy of $h$ is equivalent to non--degeneracy of the para--CR structure on $\p M$, and hence guarantees that $\theta$ is a contact form on $\p M$. Is this right?}
