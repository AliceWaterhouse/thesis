...
Let us call the solution $(V,\alpha)$ arising in Proposition \ref{prop1} the Einstein monopole, as the resulting conformal class contains an Einstein metric
...
\label{model_conf}
\mynote{Should I put this in the intro?}
